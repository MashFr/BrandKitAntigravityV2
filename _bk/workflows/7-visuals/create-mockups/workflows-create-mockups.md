...
<workflow_steps>
  ...
  <step name="Chargement des Fichiers">
    <action>
      ...
      - `brandkit_output/visuals/07_moodboard_prompts.md` (Crucial pour la cohérence lumineuse)
  ...
  <step name="Clôture">
    <action>
      Confirme la création de `brandkit_output/visuals/11_mockups_scenography.md`.
    </action>
  </step>
</workflow_steps>
